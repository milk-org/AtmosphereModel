...
int AtmosphereModel_save_stdAtmModel(ATMOSPHERE_MODEL *atm,
                                     const char *restrict fname)
{
    ...
    fprintf(fp,
            "#  1:alt[m]  2:denstot[part/cm3] 3:N2  4:O2  5:Ar  6:H2O  7:CO2  "
            "8:Ne  9:He  10:CH4  11:Kr  12:H2  "
    ...
    for (long zindex = 0; zindex < ATM_VPROF_NBSTEP; zindex++)
    {
        fprintf(fp,
                ...
                "%15.8g  %15.8g  %15.8g  %15.8g   %15.8g    %8.3lf   %12.10lf  "
                "%7.5f\n",
